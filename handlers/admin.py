...
link0 = -1001730695943 #Мокрые сливы
link1 = -1001628061570
...
link_c = [link0,link1,link2,link3,link4,link5,link6]
...
async def posting_o(chat_ids,second_start,list_otvetok,second_work):
    ...
    for link in list_otvetok:
        if 1 == 1 :
            ...
            for d in del_id:
                try:
                    await bot.delete_message(chat_id = d[1], message_id=d[0])
                except:
                    pass
